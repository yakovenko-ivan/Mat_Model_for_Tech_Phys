 ...
 * [Работа с LaTeX и Overleaf](https://github.com/yakovenko-ivan/Mat_Model_for_Tech_Phys/blob/master/files/prepare/Overleaf.md)
  ...
  * [Практика 1.](https://nbviewer.jupyter.org/github/yakovenko-ivan/Mat_Model_for_Tech_Phys/blob/d6413206614cf788d14ee2ace996e54abd4e0baa/files/Lesson_1/Lesson_2_1.ipynb?flush_cache=true) Пример реализации Метода конечных элементов для задачи переноса тепла в двухмерной области.
